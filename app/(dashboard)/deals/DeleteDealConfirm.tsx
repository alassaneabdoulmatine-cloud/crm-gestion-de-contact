...
interface DeleteDealConfirmProps {
    open: boolean
        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent size="sm">
                <AlertDialogHeader>
                    ...
                    <AlertDialogTitle className="text-sm">Supprimer le deal ?</AlertDialogTitle>

                    <AlertDialogDescription className="text-xs">
                        Cette action est irréversible. Vous êtes sur le point de supprimer définitivement
                        <span className="font-semibold text-foreground"> {dealTitle} </span>
                        ainsi que tout son historique du pipeline.
                    </AlertDialogDescription>
                </AlertDialogHeader>
